function hooldus(){
  ...
  hooldus.__sendStats = sendStats;
  hooldus.__moduleName = $intern_4;
  hooldus.__errFn = null;
  hooldus.__moduleBase = $intern_6;
  hooldus.__softPermutationId = $intern_7;
  hooldus.__computePropValue = null;
  hooldus.__getPropMap = null;
  hooldus.__installRunAsyncCode = function(){
  }
  ;
  hooldus.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  hooldus.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  hooldus.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  hooldus.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[hooldus.__softPermutationId];
    ...
    function installCode(code_0){
      ...
      if (hooldus.__errFn) {
        script.onerror = function(){
          hooldus.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  hooldus.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  hooldus.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    hooldus.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return hooldus.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    hooldus.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = hooldus.__getPropMap;
    ...
    hooldus.__softPermutationId = softPermutationId;
  ...
  processMetas();
  hooldus.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = hooldus.__moduleBase;
